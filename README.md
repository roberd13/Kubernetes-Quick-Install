...
Once the initializition is complete install your Pod Network addon Flannel in my case 
...
On your other nodes run the kubeadm command you received at the end of master initilization
...
On your Dashboard copy the token and paste it into Enter token field on log in screen. 
